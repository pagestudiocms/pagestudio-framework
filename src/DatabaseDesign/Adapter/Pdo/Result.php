...
use Iterator;
use PDOStatement;
use Ps\Framework\Database\Adapter\Driver\ResultInterface;
use Ps\Framework\Database\Adapter\Exception;
...
class Result implements Iterator, ResultInterface
{
     ...
     * @return Result
     */
    public function init(PDOStatement $resource, $generatedValue, $rowCount = null)
    {
    ...
    public function setFetchMode($fetchMode)
    {
        if ($fetchMode < 1 || $fetchMode > 10) {
            throw new \Framework\Database\Exception\InvalidArgumentException(
